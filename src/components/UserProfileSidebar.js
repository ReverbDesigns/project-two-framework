                            ...
                            <div className="mb-4 d-flex justify-content-center">
                                {
                                    ...
                                    : <img src={props.activeUser.profilePicture} className="rounded-circle avatar-lg img-thumbnail" alt="project-two-framework" />
                                }
                                                            ...
                                                            <Media className="align-items-center">
                                                                ...
                                                                <Media body>
                                                                    <div className="text-left">
                                                                        ...
                                                                        <Badge color="danger" className="badge-soft-danger float-right">{('Admin')}</Badge>
                                                                        </h5>
                                                        ...
                                                        <Card className="p-2 mb-2">
                                                            <Media className="align-items-center">
                                                                <div className="chat-avatar">
                                                                    ...
                                                                    <img src={avatar7} className="rounded-circle chat-user-img avatar-xs mr-3" alt="project-two-framework" />
                                                                </div>
                                                                <Media body>
                                                                    <div className="text-left">
