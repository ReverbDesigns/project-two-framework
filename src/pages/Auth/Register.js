                ...
                <Row className="justify-content-center">
                    <Col md={8} lg={6} xl={5}>
                        <div className="text-center mb-4">
                            ...
                            <h4>{('Sign up')}</h4>
                            <p className="text-muted mb-4">{('Get your project-two-framework account now')}.</p>
                                ...
                                <div className="p-3">
                                    ...
                                    <Form onSubmit={formik.handleSubmit}>
                                        ...
                                        <div className="mt-4 text-center">
                                            <p className="text-muted mb-0">{('By registering you agree to the project-two-framework')} <Link to="#" className="text-primary">{('Terms of Use')}</Link></p>
                                        </div>
                        ...
                        <div className="mt-5 text-center">
                            ...
                            <p>© {('2020 project-two-framework')}. </p>
                        </div>
                    </Col>
                </Row>
            </Container>
