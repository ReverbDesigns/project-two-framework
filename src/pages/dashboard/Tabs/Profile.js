...
import { activeUser } from '../../../redux/actions';
        ...
        <React.Fragment>
            <div>
                            ...
                            <div className="text-center p-4 border-bottom">
                                <div className="mb-4">
                                    <img src={avatar1} className="rounded-circle avatar-lg img-thumbnail" alt="project-two-framework" />
                                </div>

                                <h5 className="font-size-16 mb-1 text-truncate">{activeUser}</h5>
                           ...
                           {/* End profile user  */}
                            ...
                            <div className="p-4 user-profile-desc">
                                <div className="text-muted">
                                    <p className="mb-4">{("Because the world need's moreeee social media...jk.. but a foundation to something meaningful.")}</p>
                                </div>
                                    ...
                                    <Card className="shadow-none border mb-2">
                                        ...
                                        >
                                                <div>
                                                    ...
                                                    <h5 className="font-size-14">{('Jordan Bell')}</h5>
                                                </div>
