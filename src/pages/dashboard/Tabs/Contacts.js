                                                        ...
                                                        <li key={key} >
                                                            <Media className="align-items-center">
                                                                ...
                                                                <UncontrolledDropdown>
                                                                    ...
                                                                    <DropdownMenu right>
                                                                        <DropdownItem>{('Share')} <i className="ri-share-line float-right text-muted"></i></DropdownItem>
                                                                        <DropdownItem>{('Block')} <i className="ri-forbid-line float-right text-muted"></i></DropdownItem>
                                                                        <DropdownItem>{('Remove')} <i className="ri-delete-bin-line float-right text-muted"></i></DropdownItem>
                                                                    </DropdownMenu>
                                                                </UncontrolledDropdown>
                                                            </Media>
                                                        </li>
