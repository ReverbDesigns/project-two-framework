                                        ...
                                        (props.recentChatList[props.active_user].isGroup === true) ? 
                                            <li key={key} className={chat.userType === "sender" ? "right" : ""}>
                                                <div className="conversation-list">
                                                    ...
                                                    {chat.userType === "sender" ?   <img src={avatar1} alt="project-two-framework" /> : 
                                                        ...
                                                        :  <img src={props.recentChatList[props.active_user].profilePicture} alt="project-two-framework" />
                                                    }
                                                    </div>
                                                    ...
                                                    <div className="user-chat-content">
                                                            ...
                                                            </div>
                                                            {
                                                                !chat.isTyping &&
                                                                    <UncontrolledDropdown className="align-self-start">
                                                                        ...
                                                                        <DropdownMenu>
                                                                            <DropdownItem>{('Copy')} <i className="ri-file-copy-line float-right text-muted"></i></DropdownItem>
                                                                            <DropdownItem>{('Save')} <i className="ri-save-line float-right text-muted"></i></DropdownItem>
                                                        ...
                                                        {
                                                            <div className="conversation-name">{chat.userType === "sender" ? "Jordan Bell" : chat.userName}</div>
                                                        }
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <li key={key} className={chat.userType === "sender" ? "right" : ""}>
                                                <div className="conversation-list">
                                                    ...
                                                    <div className="user-chat-content">
                                                        ...
                                                        {
                                                            chatMessages[key+1] ? chatMessages[key].userType === chatMessages[key+1].userType ? null :  <div className="conversation-name">{chat.userType === "sender" ? "Jordan Bell" : props.recentChatList[props.active_user].name}</div> : <div className="conversation-name">{chat.userType === "sender" ? "Admin" : props.recentChatList[props.active_user].name}</div>
                                                        }
                                                        {/* {
                                                            <div className="conversation-name">{chat.userType === "sender" ? "Jordan" : props.recentChatList[props.active_user].name}</div>
                                                        } */}
