                                                            ...
                                                            <div className="message-img-link">
                                                                <ul className="list-inline mb-0">
                                                                    ...
                                                                    <DropdownMenu>
                                                                        ...
                                                                        <DropdownItem>{('Forward')} <i className="ri-chat-forward-line float-right text-muted"></i></DropdownItem>
                                                                        <DropdownItem>{('Delete')} <i className="ri-delete-bin-line float-right text-muted"></i></DropdownItem>
                                                                    </DropdownMenu>
